...
var status_icons = {
    ...
    "-6": '<div class="status" data-toggle="tooltip" data-placement="top" title="Did not run"><i class="fas fa-not-equal"></i><span hidden="hidden">Failed Logging Results</span></div>'
